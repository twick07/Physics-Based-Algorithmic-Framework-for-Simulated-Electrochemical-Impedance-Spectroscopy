...
%% Import PyBaMM Data
Impedance_data = xlsread("NMC_EIS_Impedance_timed.csv");
Time_data = xlsread("NMC_EIS_time_vectors_timed.csv");
Current_data = xlsread("NMC_EIS_current_vectors_timed.csv");
Voltage_data = xlsread("NMC_EIS_voltage_vectors_timed.csv");
...
figure(i+1);
dpi = 300;
print("Solver Comparison Plot NMC", '-dpng', ['-r', num2str(dpi)]);