...
# MATLAB sEIS Data
frequencies_MATLAB, Z_MATLAB = preprocessing.readCSV('Matlab_LCO_EIS_'+str(SoC)+'_SoC.csv')

# PyBaMM sEIS Data
frequencies_PyBaMM, Z_PyBaMM = preprocessing.readCSV('PyBaMM_LCO_EIS_'+str(SoC)+'_SoC.csv')
...
if SoC == 100:
    ...
    plt.grid()
    plt.legend()
    plt.savefig('ECM_Fit_Example_Plot_Error.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    plt.grid()
    plt.legend()
    plt.savefig('ECM_Fit_Example_Plot.png', dpi=300, bbox_inches='tight')
    plt.show()
...
plt.grid()
plt.legend()        
plt.savefig('ECM_Comp_SoC_'+str(SoC)+'.png', dpi=300, bbox_inches='tight')
plt.show()  
# %%
