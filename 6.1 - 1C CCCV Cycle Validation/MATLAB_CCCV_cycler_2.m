...
tol_CV = 5e-4;
N_cycles = 1; % Should be a multiple of 5
test_freq = 1;
Test_cycles = [51]; 
n_parameters = 46;
C_rate_non_test = 1;
...
if param == 1
    exampleObject = matfile('Cycler_Output_LCO.mat','Writable',true);
    save Cycler_Output_LCO.mat time_vector_total I_app_total V_cell_total

end

if param == 2
    exampleObject = matfile('Cycler_Output_NMC.mat','Writable',true);
    save Cycler_Output_NMC.mat time_vector_total I_app_total V_cell_total
