...
data = scipy.io.loadmat("Cycler_Output_NMC.mat")
...
param =2 # param = 1 for LCO/C6, param =2 for NMC532/C6
...
df.to_csv('Pybamm_custom_CCCV_voltage_ageing_NMC.csv')

#load output data into a DataFrame object:
df = pd.DataFrame(output_cell_current)

# writing output data frame to a CSV file
df.to_csv('Pybamm_custom_CCCV_current_ageing_NMC.csv')

#load output data into a DataFrame object:
df = pd.DataFrame(output_c_e)

# writing output data frame to a CSV file
df.to_csv('Pybamm_custom_CCCV_c_e_ageing_NMC.csv')

#load output data into a DataFrame object:
df = pd.DataFrame(output_c_se)

# writing output data frame to a CSV file
df.to_csv('Pybamm_custom_CCCV_c_se_ageing_NMC.csv')
...
# writing output data frame to a CSV file
df.to_csv('Pybamm_custom_CCCV_c_s_ave_ageing_NMC.csv')
