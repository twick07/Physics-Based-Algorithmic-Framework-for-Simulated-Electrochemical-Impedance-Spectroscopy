function [time_vector, I_app_EIS,idx_last_cycle,idx_penultimate] = Single_EIS_Current_Generator(Delta_I,Freq,time_step,Cycles_per_freq,last_x_cycles,Points_Per_cycle)
    ...
    %%% Find index of start of last cycle
    time_point_end_cycle = (Cycles_per_freq - 1)*(1/Freq);

    idxs = find(time_vector>time_point_end_cycle);

    idx_penultimate = idxs(1);
